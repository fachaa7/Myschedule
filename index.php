  ...
  <style>
    * {margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif;}
    ...
    input.form-control {
      ...
      border:1px solid #E2C892; border-radius:30px; 
      font-size:14px; transition:transform 0.3s, box-shadow 0.3s;
    }
    ...
    .btn-login {
      ...
      background-color:#E2C892; color:white; font-weight:600; font-size:16px;
...
<body>
  ...
  <div class="login-container">
    <!-- UBAH: Form diarahkan ke login.php -->
    <form action="login2.php" method="POST" class="needs-validation">

      <img src="https://upload.wikimedia.org/wikipedia/id/2/2c/Politeknik_Negeri_Batam.png" alt="logo" class="logo">

      <div class="mb-2">
        <label for="nama" class="form-label">Username</label>
        <!-- UBAH: tambah name="username" -->
        <input type="text" id="nama" name="username" class="form-control" placeholder="Masukkan NIM anda" required>
      </div>

      <div class="mb-2">
        <label for="password" class="form-label">Kata sandi</label>
        <!-- UBAH: tambah name="password" -->
